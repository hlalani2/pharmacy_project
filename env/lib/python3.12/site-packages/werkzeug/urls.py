...
def uri_to_iri(uri: str) -> str:
    ...
    >>> uri_to_iri("https://xn--n3h.net/p%C3%A5th?q=%C3%A8ry%DF")
    'https://\\u2603.net/p\\xe5th?q=\\xe8ry%DF'
...
def iri_to_uri(iri: str) -> str:
    ...
    >>> iri_to_uri('https://\\u2603.net/p\\xe5th?q=\\xe8ry%DF')
    'https://xn--n3h.net/p%C3%A5th?q=%C3%A8ry%DF'
